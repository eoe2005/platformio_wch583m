...
W_BDIR = '/Users/geng/.platformio/platforms/platformio_wch583m'#os.path.dirname(os.path.dirname(os.path.abspath('__file__')))
W_GCC_DIR = os.path.join(W_BDIR,"gcc")
W_GCC_BIN = os.path.join(W_BDIR,"gcc","bin")
...
env.Replace(
    AR=os.path.join(W_GCC_BIN,"riscv-none-embed-gcc-ar"),
    AS=os.path.join(W_GCC_BIN,"riscv-none-embed-as"),
    CC=os.path.join(W_GCC_BIN,"riscv-none-embed-gcc"),
    GDB=os.path.join(W_GCC_BIN,"riscv-none-embed-gdb"),
    CXX=os.path.join(W_GCC_BIN,"riscv-none-embed-g++"),
    OBJCOPY=os.path.join(W_GCC_BIN,"riscv-none-embed-objcopy"),
    RANLIB=os.path.join(W_GCC_BIN,"riscv-none-embed-ranlib"),
    SIZETOOL=os.path.join(W_GCC_BIN,"riscv-none-embed-size"),
    LDSCRIPT_PATH = os.path.join(W_BDIR,"Link_CH58x.ld"),
    ARFLAGS=["rc"],
...
def generate_openocd_action(args: List[str], action_name:str):
    ...
    if not upload_protocol in debug_tools:
        ...
        return None
    openocd_path = os.path.join(W_BDIR,"openocd","bin","openocd")
