...
SDK_DIR = join(env.PioPlatform(),"platforms","wch583m")
FRAMEWORK_DIR = join(SDK_DIR, "framework")
...
env.Append(
    ...
    CPPPATH=[
        ...
        join(variant_path, "StdPeriphDriver","inc"),
        join(FRAMEWORK_DIR),
        join(FRAMEWORK_DIR, "StdPeriphDriver"),
        join(FRAMEWORK_DIR, "StdPeriphDriver", "inc"),
